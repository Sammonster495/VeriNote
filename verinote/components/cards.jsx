export default function Cards(props){
    return(
        <div className={`bg-[#D9D9D9] md:h-[26rem] sm:h-80 h-48 lg:w-56 md:w-48 sm:w-40 w-full sm:m-0 mb-8 justify-self-center grid grid-cols-2 sm:flex flex-col${props.pos}`}>
